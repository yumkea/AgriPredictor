package com.agripredictor.plantservice;
...
@MapperScan("com.agripredictor.plantservice.mapper")
@ComponentScan(basePackages = {"com.agripredictor.*"})
@SpringBootApplication
public class PlantServiceApplication implements CommandLineRunner {
	@Resource
